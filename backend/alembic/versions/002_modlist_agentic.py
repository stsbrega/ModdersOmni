...
def upgrade() -> None:
    ...
    op.add_column("modlist_entries", sa.Column("nexus_mod_id", sa.Integer(), nullable=True))
    op.add_column("modlist_entries", sa.Column("name", sa.String(255), nullable=True))
    op.add_column("modlist_entries", sa.Column("author", sa.String(100), nullable=True))
    op.add_column("modlist_entries", sa.Column("summary", sa.Text(), nullable=True))
    op.add_column("modlist_entries", sa.Column("reason", sa.Text(), nullable=True))
    op.add_column("modlist_entries", sa.Column("is_patch", sa.Boolean(), server_default="false", nullable=False))
    op.add_column("modlist_entries", sa.Column("patches_mods", sa.JSON(), nullable=True))
    op.add_column("modlist_entries", sa.Column("compatibility_notes", sa.Text(), nullable=True))
